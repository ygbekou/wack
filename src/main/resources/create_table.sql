...
CREATE TABLE VISIT (
     ...
     , PATIENT_ID BIGINT NOT NULL  
     , VISIT_NUMBER VARCHAR(25) NOT NULL
...
CREATE TABLE PATIENT_SALE_RETURN (
  	PATIENT_SALE_RETURN_ID BIGINT NOT NULL AUTO_INCREMENT
  , PATIENT_SALE_ID BIGINT NOT NULL
  , PRODUCT_ID BIGINT NOT NULL
  , RETURN_DATETIME DATE NOT NULL
  , QUANTITY SMALLINT NOT NULL
  , UNIT_PRICE DOUBLE NOT NULL
  , TOTAL_AMOUNT DOUBLE NOT NULL
  , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_BY BIGINT NOT NULL DEFAULT 1
  , PRIMARY KEY (PATIENT_SALE_RETURN_ID)
  , CONSTRAINT FK_PATIENT_SALE_RETURN_1 FOREIGN KEY (PATIENT_SALE_ID)
                  REFERENCES PATIENT_SALE (PATIENT_SALE_ID)
  , CONSTRAINT FK_PATIENT_SALE_RETURN_2 FOREIGN KEY (PRODUCT_ID)
                  REFERENCES PRODUCT (PRODUCT_ID)
);
