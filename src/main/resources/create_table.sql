...
CREATE TABLE PRESCRIPTION (
     ...
     , CONSTRAINT FK_PRESCRIPTION_1 FOREIGN KEY (ADMISSION_ID)
...
CREATE TABLE DOCTOR_ORDER (
     ...
     , CONSTRAINT FK_DOCTOR_ORDER_3 FOREIGN KEY (DOCTOR_ORDER_PRIORITY_ID)
               REFERENCES DOCTOR_ORDER_PRIORITY (DOCTOR_ORDER_PRIORITY_ID)
     , CONSTRAINT FK_DOCTOR_ORDER_4 FOREIGN KEY (DOCTOR_ID)
                  REFERENCES EMPLOYEE (EMPLOYEE_ID)
     , CONSTRAINT FK_DOCTOR_ORDER_5 FOREIGN KEY (DOCTOR_ORDER_KIND_ID)
