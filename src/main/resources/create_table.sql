...
CREATE TABLE OCCUPATION (
  OCCUPATION_ID TINYINT NOT NULL AUTO_INCREMENT
  , NAME VARCHAR(64) NOT NULL
  , DESCRIPTION VARCHAR(250)
  , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
  , MOD_DATE TIMESTAMP NOT NULL DEFAULT NOW()
...
CREATE TABLE PATIENT_ADMISSION (
	   PATIENT_ADMISSION_ID BIGINT NOT NULL AUTO_INCREMENT 
     , PATIENT_ID BIGINT NOT NULL 
     , PACKAGE_ID BIGINT 
     , INSURANCE_ID BIGINT
     , DOCTOR_ID BIGINT NOT NULL 
     , ADMISSION_DATE DATE NOT NULL
     , DISCARGE_DATE DATE NOT NULL
     ...
     , CONSTRAINT FK_PATIENT_ADMISSION_1 FOREIGN KEY (PATIENT_ID)
                  REFERENCES PATIENT (PATIENT_ID)
     , CONSTRAINT FK_PATIENT_ADMISSION_2 FOREIGN KEY (PACKAGE_ID)
                  REFERENCES PACKAGE (PACKAGE_ID)
     , CONSTRAINT FK_PATIENT_ADMISSION_3 FOREIGN KEY (INSURANCE_ID)
      			  REFERENCES INSURANCE (INSURANCE_ID)
      , CONSTRAINT FK_PATIENT_ADMISSION_4 FOREIGN KEY (DOCTOR_ID)
     			  REFERENCES EMPLOYEE (EMPLOYEE_ID)
);
...
CREATE TABLE BILL (
     ...
     , CREATE_DATE TIMESTAMP NOT NULL DEFAULT NOW()
	   ...
	   , STATUS SMALLINT DEFAULT 0
     , PRIMARY KEY (BILL_ID)
     , CONSTRAINT FK_BILL_1 FOREIGN KEY (PATIENT_ADMISSION_ID)
                  REFERENCES PATIENT_ADMISSION (PATIENT_ADMISSION_ID)
...
CREATE TABLE VITAL_SIGN (
     ...
     , CONSTRAINT FK_VITAL_SIGN_1 FOREIGN KEY (APPOINTMENT_ID)
               REFERENCES APPOINTMENT (APPOINTMENT_ID)
);
...
CREATE TABLE DOCTOR_ORDER (
     ...
     , CONSTRAINT FK_DOCTOR_ORDER_1 FOREIGN KEY (APPOINTMENT_ID)
               REFERENCES APPOINTMENT (APPOINTMENT_ID)
     , CONSTRAINT FK_DOCTOR_ORDER_2 FOREIGN KEY (DOCTOR_ORDER_TYPE_ID)
