...
import com.softenza.emarket.util.DateUtil;
...
public class GenericDaoImpl<E, K> implements GenericDao<E, K> {
	...
	public void delete(Class cl, List<Long> ids) {
		 ...
		 * entityManager.getCriteriaBuilder().createCriteriaDelete(cl); Root root =
		 * criteria.from(cl); criteria.where(root.get("id").in(ids));
		 * 
